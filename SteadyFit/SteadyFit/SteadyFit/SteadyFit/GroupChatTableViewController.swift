...
class GroupChatTableViewController: UICollectionViewController, UITextFieldDelegate, UICollectionViewDelegateFlowLayout{
    ...
    var myUserID:String = "9mE5Dy4k35XsG57FXYmRPMr5giI3"
...
//        let sender = rawMessages[indexPath.item].senderName
...
//    // Work in progress, trying to get estimate height for each chat box
//    private func estimateFrameHeight(text: String) -> CGRect{
//        let size = CGSize(width: 200, height: 1000)
//        let option = NSStringDrawingOptions.usesFontLeading.union(.usesLineFragmentOrigin)
//        return NSString(string: text).boundingRect(with: size, options: option, attributes: [NSAttributedString.Key.font : UIFont.systemFont(ofSize: 15)], context: nil)
//    }
